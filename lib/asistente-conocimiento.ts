...
2. "Video" — SOLO aparece en los módulos que tienen un video cargado; en el resto esa pestaña no existe y eso es NORMAL, no es un fallo ni un bloqueo. Los videos del programa van DENTRO de las lecciones de la pestaña "Teoría", no en una pestaña aparte.
   Si alguien pregunta dónde están los videos: en Teoría, dentro de la lección que trata ese tema. Son videos escogidos de otros creadores; Juan no publica clases suyas en el portal.
